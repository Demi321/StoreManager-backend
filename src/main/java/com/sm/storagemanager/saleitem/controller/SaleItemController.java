package com.sm.storagemanager.saleitem.controller;
...
public class SaleItemController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SaleItemDto> findById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SaleItemDto> update(@PathVariable Long id, @RequestBody SaleItemDto dto) {
